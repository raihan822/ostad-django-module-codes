...
- URLs e thakbe routings. ja `urlpatterns[]` er vitor `'' -> root`, `'', include("string py file name")` ebhabe thakbe. [include er string location file import kora lage na. Django nije kore nae]
